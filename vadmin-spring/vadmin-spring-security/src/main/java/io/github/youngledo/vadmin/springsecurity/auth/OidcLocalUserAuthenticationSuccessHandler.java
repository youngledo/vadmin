...
public final class OidcLocalUserAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    private java.util.Optional<io.github.youngledo.vadmin.contracts.auth.LocalUserAccount>
        ...
        try {
            return identityMapper.map(identityFactory.from(oidcUser))
                    ...
                    .filter(io.github.youngledo.vadmin.contracts.auth.LocalUserAccount::enabled);
