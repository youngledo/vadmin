...
class SystemAdministrationModuleConfigurationTest {
    ...
    void contributesAllSystemPagesAndTheirDeclaredPermissions() {
        ...
        assertThat(module.id()).isEqualTo("system");
        assertThat(module.pages()).extracting(page -> page.route())
                .containsExactly("users", "roles", "permissions", "audit");
        assertThat(module.pages()).extracting(page -> page.viewType())
                .containsExactly(UsersView.class, RolesView.class, PermissionsView.class, AuditView.class);
        assertThat(module.declaredPermissions()).contains(
